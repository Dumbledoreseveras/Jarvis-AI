...
# Async function for the hugging Face stable Diffusion model
...
def GenerateImages(prompt: str):
    ...
    open_images(prompt) # open the genrate images
...
while True:
    ...
    try:
        ...
        if Status == "True":
            ...
            # Reset the status in the file after processing the request
            with open(r"Frontend\Files\ImageGeneration.data", "w") as f:
                f.write("False, False")
                break   #Exit for 1 second before processing the request
